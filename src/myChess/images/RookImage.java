...
public class RookImage implements PieceImage {
    ...
    public Image loadImage(Object spec) {
        if (spec.equals(Color.WHITE)) {
            ...
            return (white = new ImageIcon("/home/kali/IdeaProjects/MyChess/resources/images/rook_white.png").getImage());
        }
        else if (spec.equals(Color.BLACK)){
            if (black != null) return black;
            return (black = new ImageIcon("/home/kali/IdeaProjects/MyChess/resources/images/rook_black.png").getImage());
        }
        else if (spec.equals(Color.BLUE)){
            if (blue != null) return blue;
            return (blue = new ImageIcon("/home/kali/IdeaProjects/MyChess/resources/images/rook_blue.png").getImage());
        }
        else if (spec.equals(Color.RED)){
            if (red != null) return red;
            return (red = new ImageIcon("/home/kali/IdeaProjects/MyChess/resources/images/rook_red.png").getImage());
        }
